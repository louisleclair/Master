...
def Lab4_Network():
    ...
    for router in routers:
        ...
        router.cmd('zebra -d -f /home/lca2/Desktop/lab4/configs/zebra_r%s.cfg -i /home/lca2/Desktop/lab4/run/zebra_r%s.pid -z /home/lca2/Desktop/lab4/run/frr_r%s.api -u root -k' % (index, index, index))
        if index != 4:
        	router.cmd('ospf6d -d -f /home/lca2/Desktop/lab4/configs/ospf6d_r%s.cfg -i /home/lca2/Desktop/lab4/run/ospf6d_r%s.pid -z /home/lca2/Desktop/lab4/run/frr_r%s.api -u root' % (index, index, index))
